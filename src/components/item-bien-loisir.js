...
class ItemLoisir extends Component {
    constructor(props) {
        super(props);
        this.state = { 
          isFlipped: false
  ...
  return (
    <div>
    {item.confirmation === "confirme" && item.Categbien === "Loisirs et Divertissement"?
...
export default connect(null,mapDispatchToProps)(ItemLoisir); 