...
class ItemHabi extends Component {
    constructor(props) {
        super(props);
        this.state = { 
          isFlipped: false
  ...
  return (
    <div>
    {item.confirmation === "confirme" && item.Categbien === "Habillement et Bien Etre"?
...
export default connect(null,mapDispatchToProps)(ItemHabi); 